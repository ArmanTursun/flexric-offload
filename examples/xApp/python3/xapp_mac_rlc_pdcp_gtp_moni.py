    ...
    def handle(self, ind):
        ...
        if len(ind.ue_stats) > 0:
            ...
            for ue_id in range(len(ind.ue_stats)):
                ...
                #print('[xApp Monitor 1]: TBS = ' + str(ue_context.dl_harq[0]) + ', timestamp = ' + str(ind.tstamp) + ', frame = ' + str(ue_context.dl_harq[1]) + ', slot = ' + str(ue_context.dl_harq[2]) + ', rnti = ' + str(ue_context.rnti) + ', latency = ' + str(ue_context.dl_harq[3]) + ', crc = ' + str(ue_context.dl_harq[4]))
                #print('[xApp Monitor 2]: TBS = ' + str(ue_context.ul_harq[0]) + ', timestamp = ' + str(ind.tstamp) + ', frame = ' + str(ue_context.ul_harq[1]) + ', slot = ' + str(ue_context.ul_harq[2]) + ', rnti = ' + str(ue_context.rnti) + ', latency = ' + str(ue_context.ul_harq[3]) + ', crc = ' + str(ue_context.ul_harq[4]))
                ...
                #for tbs_stats in ue_context.tbs:
                    #tbs_stats = ue_context.tbs[tbs_id]
                    #print('[xApp Monitor]: TBS = ' + str(tbs_stats.tbs) + ', timestamp = ' + str(ind.tstamp) + ', frame = ' + str(tbs_stats.frame) + ', slot = ' + str(tbs_stats.slot) + ', rnti = ' + str(ue_context.rnti) + ', latency = ' + str(tbs_stats.latency) + ', crc = ' + str(tbs_stats.crc))
